...
export class CanvasBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: unknown) {
    ...
    /* Release the loader. With the scene dead nobody will ever report the
       first frame, and the overlay must not hold the museum hostage. */
    useScene.getState().setReady(true);
  }
