...
export function useDpr(): [number, number] {
  ...
  /* 2x on a desktop means four times the pixels of 1x, and with the full
	   post-processing stack that was the whole desktop slowdown. 1.5 is the
	   sweet spot: still crisp, roughly half the fragments. */
  return mobile ? [1, 1.5] : [1, 1.5];
}
